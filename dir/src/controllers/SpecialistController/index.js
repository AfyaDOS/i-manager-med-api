    ...
    index(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const specialtist = yield repositorySpecialist.find({
    ...
    createSpecialist(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const registryExists = yield repositorySpecialist.findOne({
                    where: { registry },
                });
                if (registryExists) {
                ...
                const specialist = repositorySpecialist.create({
                    ...
                    cell,
                    specialties,
                    address_id: address_id === null || address_id === void 0 ? void 0 : address_id.id,
                });
    ...
    updateSpecialist(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const registryExists = yield repositorySpecialist.findOne({
                    where: { registry: data === null || data === void 0 ? void 0 : data.registry },
                });
                if (registryExists) {
                    return res.status(409).send('Registro já cadastrado');
                }
                ...
                yield repositorySpecialist.save(specialist);
                const address = yield repositoryAddress.findOne(data.address_id.id);
                yield Object.assign(address, Object.assign({}, data.address_id));
                // @ts-ignore
